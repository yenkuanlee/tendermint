...
const (
	...
	// https://github.com/yenkuanlee/tendermint/pull/3438
...
// dbStore wraps a db (github.com/yenkuanlee/tm-db)
type dbStore struct {
	db dbm.DB
}
...
// encoding not preserving ordering: https://github.com/yenkuanlee/tendermint/issues/4567
