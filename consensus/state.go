...
import (
	...
	"github.com/yenkuanlee/tendermint/libs/fail"
	...
	cstypes "github.com/yenkuanlee/tendermint/consensus/types"
...
func (cs *ConsensusState) handleMsg(mi msgInfo) {
	...
	case *VoteMessage:
		...
		// a typical peer.
		// https://github.com/yenkuanlee/tendermint/issues/1281
		// }
	...
	if err != nil { // nolint:staticcheck
		...
		// https://github.com/yenkuanlee/tendermint/issues/3406
...
func (cs *ConsensusState) tryAddVote(vote *types.Vote, peerID p2p.ID) (bool, error) {
	...
	if err != nil {
		...
		if err == ErrVoteHeightMismatch {
			...
			// 3) tmkms use with multiple validators connecting to a single tmkms instance (https://github.com/yenkuanlee/tendermint/issues/3839).
