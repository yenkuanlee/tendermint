...
import (
	...
	types "github.com/yenkuanlee/tendermint/rpc/lib/types"
)
...
// If some writes don't set it while others do, they may timeout incorrectly (https://github.com/yenkuanlee/tendermint/issues/553)
