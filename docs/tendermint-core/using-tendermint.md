...
definition](https://github.com/yenkuanlee/tendermint/blob/master/types/genesis.go)).
...
- `consensus_params` [spec](https://github.com/yenkuanlee/tendermint/blob/master/spec/core/state.md#consensusparams)
    - `block`
...
See the
[UPGRADING.md](https://github.com/yenkuanlee/tendermint/blob/master/UPGRADING.md)
