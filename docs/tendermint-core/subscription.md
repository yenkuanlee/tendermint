...
[List of events](https://godoc.org/github.com/yenkuanlee/tendermint/types#pkg-constants)
...
section](https://github.com/yenkuanlee/tendermint/blob/master/spec/abci/abci.md#endblock) in
the ABCI spec).
