...
```sh
go get github.com/yenkuanlee/tendermint
cd $GOPATH/src/github.com/yenkuanlee/tendermint
make install_abci
```
...
human-readable](https://github.com/yenkuanlee/tendermint/issues/1794).
