...
configuration of the Proposer-Based Timestamps [SynchronyParams](https://github.com/yenkuanlee/tendermint/blob/master/spec/core/data_structures.md#synchronyparams).
...
To use this runbook, you must be running a node that has the [Prometheus metrics endpoint enabled](https://github.com/yenkuanlee/tendermint/blob/master/docs/nodes/metrics.md)
...
the consensus parameters via ABCI can be found in the [FinalizeBlock documentation](https://github.com/yenkuanlee/tendermint/blob/master/spec/abci++/abci++_methods_002_draft.md#finalizeblock).
