...
overlap or conflict with the upcoming introduction of [ABCI++](https://github.com/yenkuanlee/tendermint/blob/master/docs/rfc/rfc-013-abci%2B%2B.md).

For more information on the various approaches and proposals, please see the
[mempool discussion](https://github.com/yenkuanlee/tendermint/discussions/6295).
...
- [ABCI++](https://github.com/yenkuanlee/tendermint/blob/master/docs/rfc/rfc-013-abci%2B%2B.md)
- [Mempool Discussion](https://github.com/yenkuanlee/tendermint/discussions/6295)
