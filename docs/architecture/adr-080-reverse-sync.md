...
Two new features: [Block pruning](https://github.com/yenkuanlee/tendermint/issues/3652)
and [State sync](https://github.com/yenkuanlee/tendermint/blob/master/docs/architecture/adr-042-state-sync.md)
...
tackled with [RFC-001](https://github.com/yenkuanlee/tendermint/blob/master/docs/architecture/adr-077-block-retention.md).
...
- [RFC-001: Block retention](https://github.com/yenkuanlee/tendermint/blob/master/docs/architecture/adr-077-block-retention.md)
- [Original issue](https://github.com/yenkuanlee/tendermint/issues/4629)
