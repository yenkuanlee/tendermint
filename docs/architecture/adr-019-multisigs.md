...
This ADR assumes that [replacing crypto.Signature with []bytes](https://github.com/yenkuanlee/tendermint/issues/1957) has been accepted.
...
Evidence for this is outlined in [this issue](https://github.com/yenkuanlee/tendermint/issues/2077).
